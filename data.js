const DIAGNOSIS_DATA = {
  config: {
    grade_scope: "初二升初三暑期",
    learned_until: "初二下学期结束",
    default_textbook_version: "苏教版",
  },
  students: [
    { id: "S001", name: "李悦嘉" },
    { id: "S002", name: "李承岳" },
  ...
  papers: [
    ...
    },
    {
      ...
      totalScore: 100,
      questions: [
        { no: "1", type: "选择题", score: 10, difficulty: "基础", difficulty_level: 1, grade_scope: "初二升初三暑期", learned_until: "初二下学期结束", is_available_for_grade8_summer: true, knowledgeId: "P002", knowledge: "速度公式", prompt: "物体 10 秒通过 50 米，速度是（ ）。", options: ["A. 2 m/s", "B. 5 m/s", "C. 10 m/s", "D. 50 m/s"], answer: "B", rubric: "选 B 得 10 分。", grading: "objective" },
        { no: "2", type: "选择题", score: 10, difficulty: "基础", difficulty_level: 1, grade_scope: "初二升初三暑期", learned_until: "初二下学期结束", is_available_for_grade8_summer: true, knowledgeId: "P004", knowledge: "声音传播", prompt: "声音在真空中（ ）。", options: ["A. 能传播", "B. 不能传播", "C. 传播最快", "D. 传播最慢"], answer: "B", rubric: "选 B 得 10 分。", grading: "objective" },
        { no: "3", type: "选择题", score: 10, difficulty: "基础", difficulty_level: 1, grade_scope: "初二升初三暑期", learned_until: "初二下学期结束", is_available_for_grade8_summer: true, knowledgeId: "P106", knowledge: "平面镜成像", prompt: "平面镜成像的特点是（ ）。", options: ["A. 实像", "B. 像比物大", "C. 像与物等大", "D. 像在镜前"], answer: "C", rubric: "选 C 得 10 分。", grading: "objective" },
        { no: "4", type: "选择题", score: 10, difficulty: "基础", difficulty_level: 1, grade_scope: "初二升初三暑期", learned_until: "初二下学期结束", is_available_for_grade8_summer: true, knowledgeId: "P203", knowledge: "二力平衡", prompt: "一个物体在两个力作用下保持静止，这两个力大小相等、方向相反，并作用在（ ）。", options: ["A. 同一直线上", "B. 不同物体上", "C. 任意方向", "D. 任意位置"], answer: "A", rubric: "选 A 得 10 分。", grading: "objective" },
        { no: "5", type: "计算题", score: 15, difficulty: "中档", difficulty_level: 2, grade_scope: "初二升初三暑期", learned_until: "初二下学期结束", is_available_for_grade8_summer: true, knowledgeId: "P205", knowledge: "压强计算", prompt: "一个物体对地面的压力为 100N，受力面积为 0.5m²，求压强。", answer: "200Pa", rubric: "写出 p=F/S 得 5 分，代入 100/0.5 得 5 分，结果 200Pa 得 5 分。", grading: "subjective", keywords: ["p=F/S", "100", "0.5", "200"] },
        { no: "6", type: "计算题", score: 15, difficulty: "中档", difficulty_level: 2, grade_scope: "初二升初三暑期", learned_until: "初二下学期结束", is_available_for_grade8_summer: true, knowledgeId: "P208", knowledge: "浮力基础", prompt: "物体排开水的重力为 8N，根据阿基米德原理，物体受到的浮力是多少？", answer: "8N", rubric: "写出浮力等于排开液体所受重力得 8 分，结果 8N 得 7 分。", grading: "subjective", keywords: ["排开", "重力", "8"] },
        { no: "7", type: "计算题", score: 15, difficulty: "中档", difficulty_level: 2, grade_scope: "初二升初三暑期", learned_until: "初二下学期结束", is_available_for_grade8_summer: true, knowledgeId: "P301", knowledge: "功的计算", prompt: "用 20N 的力使物体沿力的方向移动 3m，求这个力做的功。", answer: "60J", rubric: "写出 W=Fs 得 5 分，代入 20×3 得 5 分，结果 60J 得 5 分。", grading: "subjective", keywords: ["W=Fs", "20", "3", "60"] },
        { no: "8", type: "应用题", score: 15, difficulty: "综合", difficulty_level: 3, grade_scope: "初二升初三暑期", learned_until: "初二下学期结束", is_available_for_grade8_summer: true, knowledgeId: "P302", knowledge: "功率基础", prompt: "小明用 10 秒完成 200J 的功，求他的功率。", answer: "20W", rubric: "写出 P=W/t 得 5 分，代入 200/10 得 5 分，结果 20W 得 5 分。", grading: "subjective", keywords: ["P=W/t", "200", "10", "20"] },
        { no: "X1", type: "实验题", score: 0, difficulty: "超纲", difficulty_level: 9, grade_scope: "初三阶段", learned_until: "初三学习后", is_available_for_grade8_summer: false, excluded_reason: "超出初二下学期结束知识边界，暂不进入初二升初三暑期测试与任务规划。", knowledgeId: "P403", knowledge: "欧姆定律实验", prompt: "在探究电流与电压关系的实验中，为什么要保持电阻不变？", answer: "为了控制变量，只研究电压变化对电流的影响。", rubric: "指出控制变量 10 分，说明只研究电压对电流影响 10 分。", grading: "subjective", keywords: ["控制变量", "电阻不变", "电压", "电流"] },
        { no: "X2", type: "综合题", score: 0, difficulty: "超纲", difficulty_level: 9, grade_scope: "初三阶段", learned_until: "初三学习后", is_available_for_grade8_summer: false, excluded_reason: "超出初二下学期结束知识边界，暂不进入初二升初三暑期测试与任务规划。", knowledgeId: "P404", knowledge: "电功率", prompt: "某用电器两端电压 220V，电流 0.5A，求电功率，并说明单位。", answer: "110W", rubric: "写出 P=UI 得 6 分，代入 220×0.5 得 6 分，结果 110W 得 6 分，单位正确 2 分。", grading: "subjective", keywords: ["P=UI", "220", "0.5", "110", "W"] },
      ],
    },
  ],
  resources: [
    { subject: "数学", grade: "八年级", textbook_version: "苏教版", chapter: "数与代数", knowledge_point: "有理数混合运算", title: "苏教版八年级数学：有理数混合运算", url: "", source: "待补充", status: "pending_review" },
    { subject: "语文", grade: "八年级", textbook_version: "苏教版", chapter: "阅读与写作", knowledge_point: "信息提取", title: "苏教版八年级语文：现代文信息提取", url: "", source: "待补充", status: "pending_review" },
    { subject: "英语", grade: "八年级", textbook_version: "苏教版", chapter: "语法与阅读", knowledge_point: "一般过去时", title: "苏教版八年级英语：一般过去时", url: "", source: "待补充", status: "pending_review" },
    { subject: "物理", grade: "八年级", textbook_version: "苏教版", chapter: "运动与力", knowledge_point: "速度公式", title: "苏教版八年级物理：速度公式", url: "", source: "待补充", status: "pending_review" },
    { subject: "物理", grade: "八年级", textbook_version: "苏教版", chapter: "运动与力", knowledge_point: "二力平衡", title: "苏教版八年级物理：二力平衡", url: "", source: "待补充", status: "pending_review" },
    { subject: "物理", grade: "八年级", textbook_version: "苏教版", chapter: "压强与浮力", knowledge_point: "压强计算", title: "苏教版八年级物理：压强计算", url: "", source: "待补充", status: "pending_review" },
    { subject: "物理", grade: "八年级", textbook_version: "苏教版", chapter: "压强与浮力", knowledge_point: "浮力基础", title: "苏教版八年级物理：浮力基础", url: "", source: "待补充", status: "pending_review" },
    { subject: "物理", grade: "八年级", textbook_version: "苏教版", chapter: "功和机械能", knowledge_point: "功的计算", title: "苏教版八年级物理：功的计算", url: "", source: "待补充", status: "pending_review" },
    { subject: "物理", grade: "八年级", textbook_version: "苏教版", chapter: "功和机械能", knowledge_point: "功率基础", title: "苏教版八年级物理：功率基础", url: "", source: "待补充", status: "pending_review" },
  ],
};
